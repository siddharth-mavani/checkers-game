...
int Undo(int u[8][8], struct Game_Spec *G , int* Player, int CallNextKMoves);
...
bool PossibleMoves(char c,int x, int board[8][8],int player,bool print,bool capture); //Checks if moves are possible for a specific piece and can print them 
